	...
	cases := []struct {
	...
	}{
		{
			...
			want: step.ExitUnsafeToReboot{
				errors.Errorf("Cannot upgrade this version (ventura-v2024.46.1-QuantaRelease) due to S483584"),
			},
		},
		{
			...
			v_err:        nil,
			want: step.ExitUnsafeToReboot{
				errors.Errorf("Cannot upgrade this version (ventura-v2025.02.1) due to S483584"),
			},
		},
		{
